...
Config::set('MELLIVORA_CONFIG_SITE_NAME', 'Pragyan CTF 2021');
Config::set('MELLIVORA_CONFIG_SITE_SLOGAN', 'Pragyan, The ByteHoc');
Config::set('MELLIVORA_CONFIG_SITE_DESCRIPTION', '');

Config::set('MELLIVORA_CONFIG_SITE_URL', 'http://localhost:4040/');
Config::set('MELLIVORA_CONFIG_SITE_URL_STATIC_RESOURCES', 'http://localhost:4040/');
...
Config::set('MELLIVORA_CONFIG_EMAIL_FROM_EMAIL', 'ln.meivenkatkumar21@gmail.com');
Config::set('MELLIVORA_CONFIG_EMAIL_FROM_NAME', 'Pragyan CTF 2021');
...
Config::set('MELLIVORA_CONFIG_EMAIL_SMTP_AUTH', false);
