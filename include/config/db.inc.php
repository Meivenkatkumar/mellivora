...
Config::set('MELLIVORA_CONFIG_DB_HOST', 'db');
Config::set('MELLIVORA_CONFIG_DB_PORT', 3306);
Config::set('MELLIVORA_CONFIG_DB_NAME', 'PCTF21');
Config::set('MELLIVORA_CONFIG_DB_USER', 'PCTF21_root');
Config::set('MELLIVORA_CONFIG_DB_PASSWORD', 'FWEBFREWI232nbkjfvger2r2bjed');